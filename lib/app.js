...
import MumbleNet from 'mumblenet';
...
var App = {
    ...
    peermsg_handler: function (payload, info) {
        try {
            ...
            mumble.notify.error("Peer message handling error: %j", err, true);
        }
    },
    ...
    load: function () {
        try {
            ...
            try {
                logger.error("Error in initializing Mumble application: " + err.message);   
            }
            catch (e) { }                   

            if (mumble.notify.error) {
                mumble.notify.error("Error in initializing Mumble application: " + err.message);
            }
            else {
