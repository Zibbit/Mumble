...
(function () {
    ...
    percomm.onPeerError = function (payload) {
        try {
            ...
            if (!ishandled) {
                ...
                mumble.notify.error("onPeerError error %j", err);
            }
        }
        catch (e) {
    ...
    function handleAcceptKey(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("handleAcceptKey error %j", e);
        }
    }
    ...
    function handleKeyExchange(sender, public_key, payload, msgtext) {
        try {
            ...
            try {
                ...
                return mumble.notify.error("Peer send message error %j", pserr, true);
            }
            ...
            mumble.notify.error("Handle key exchange error %j", e);
        }
    }
        ...
        try {
            ...
            contactlist.update(contact, function () {
                try {
                    ...
                    mumble.notify.error("Handle ping, after database update error %j", e, true);
                }
            });
            
        }
        catch (e) {
            mumble.notify.error("handlePing error %j", e, true);
        }
    }
    ...
    function handlePingReply(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("handlePingReply error %j", e);
        }
    }
    ...
    function handleHangupCall(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("handleCallReply error %j", e);
        }
    }
    ...
    function handleShareScreenOffer(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("Handle share screen offer error %j", e, true);
        }
    }
    ...
    function handleShareScreenReply(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("Share screen reply handler error %j", e);
        }
    }
    ...
    function handleCall(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("Handle call error %j", e);
        }
    }
    ...
    function handleOfferTextChat(sender, payload, data) {
        try {
            ...
            mumble.notify.error("Handle offer text chat error:  %j", e, true);
        }
    }
    ...
    function handleFileInit(sender, payload, data) {
        try {
            ...
            mumble.notify.error("handleFileInit error %j", e);
        }
    }
    ...
    function handleAddContactRequest(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("handleAddContactRequest error %j", e);
        }
    }
    ...
    function handleAddContactDenyReply(sender, payload, msgtext) {
        try {
            ...
            mumble.notify.error("handleAddContactDenyReply error %j", e);
        }
    }
    ...
    function handleSymmMessage(sender, payload, msgtext) {
        try {
            ...
            switch (data.cmd) {
                case defs.PEERMSG_TXTMSG:
                    try {
                        ...
                        mumble.notify.error("Error in handling chat message %j", e);
                    }
                    break;
            ...
            mumble.notify.error("handleSymmMessage error %j", e);
        }
    }
    ...
    percomm.onPeerMessage = function (data, info) {
        try {
            if (!appsrvc.account_connected) {
                return mumble.notify.info("Peer message received but the user is not initialized", null, true);
            }
            ...
            mumble.notify.error("Error in handling peer message: %j", err, true);
        }
    }
    ...
    function wait_peer_reply(jti, timeout, showprog) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                ...
                if (showprog) {
                    mumble.notify.info("Waiting reply from peer ... ", null, true);
                }
    ...
    percomm.addcontact_message = function (contact, callback) {
        try {
            ...
            net.client.put(key, value, function (err) {
                if (err) {
                    return mumble.notify.error("Add-contact request put error %j", err, true);
                }
            ...
            mumble.notify.error("Add contact message error %j", e, true);
        }
    }
    ...
    percomm.declinecontact_message = function (contact, callback) {
        try {            
            ...
            net.client.put(key, value, function (err) {
                if (err) {
                    return mumble.notify.error("declinecontact_message error %j", err);
                }
            ...
            mumble.notify.error("declinecontact_message error %j", e);
        }
    }
    ...
    percomm.send_peer_message = function (contact, message) {
        try {
            ...
            mumble.notify.error("Send peer message error: %j", e, true);
        }
    }
    ...
    percomm.get_peer_message = function (contact, message) {
        try {
            ...
            mumble.notify.error("Get peer message error: %j", e, true);
        }
    }
    ...
    percomm.send_addcontact_request = function (contact) {
        try {             
            ...
            mumble.notify.error("Send add contact request error:  %j", err);
        }        
    }
    ...
    percomm.send_accept_addcontact_reply = function (contact) {
        try {
            ...
            mumble.notify.error("Send addcontact request error:  %j", err);
        }
    }
    ...
    percomm.send_decline_addcontact_reply = function (contact) {
        try {
            ...
            mumble.notify.error("Send decline contact reply error:  %j", err);
        }
    }
    ...
    percomm.delete_item = function (key, request) {
        try {
            ...
            mumble.notify.error("delete_item error:  %j", e);
        }
    }
    ...
    percomm.delete_message = function (msgid, publickey, sender, recipien, callback) {
        try {            
            ...
            mumble.notify.error("delete_message error:  %j", e);
        }
    }
    ...
    percomm.offer_contact = function (account, user_pkhash, user_public_key, contact_bs58public_key, connsymmkey, transport, address, port, type, callback) {
        try {
            if (!callback || typeof callback != "function") {
