                ...
                this.submit = function () {
                    try {
                        ...
                        user.change_password(this.current_account, password, function (err) {
                            if (err) {
                                return mumble.notify.error("Error in changing password: %j", err);
                            }

                            mumble.notify.info("The password for account " + self.accountname() + " was changed");
                        ...
                        mumble.notify.error("Error in changing the password: %j", err);
                    }
                };
            }
