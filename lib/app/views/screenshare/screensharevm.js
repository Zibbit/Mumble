...
(function () {
    define(['knockout', 'appevents', 'peercomm', 'webrtcscreen', 'webrtcaudio', './screen.html!text'],
        function (ko, appevents, peercomm, webrtcscreen, webrtcaudio, template) {
        ...
        function ScreenShareViewModel(params) {
            var vm = {
                ...
                onPeerHangup: function () {
                    ...
                    mumble.notify.info("The call has been terminated by the contact");
                }
            };
