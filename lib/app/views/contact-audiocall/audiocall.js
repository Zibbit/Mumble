...
(function () {
    define(
        [
            'knockout', 'appevents', 'contactlist', 'peercomm', 'appsrvc', 'definitions', 'utilities', 'makeusabrew/bootbox',
            'webrtccall', 'filesender', 'uuid', 'connections', './audiocall.html!text'
        ],
        function (
            ko, appevents, contactlist, peercomm, appsrvc, defs, utilities, bootbox,
                ...
                var viewModel = {
                    ...
                    dispose: function () {
                        try {
                            ...
                            mumble.notify.error("AudioCallVM dispose %j", err, true);
                        }
                    },
