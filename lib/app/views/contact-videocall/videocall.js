...
(function () {
    define(
        [
            'knockout', 'appevents', 'contactlist', 'peercomm', 'appsrvc', 'definitions', 'utilities',
            'makeusabrew/bootbox', 'webrtccall', 'uuid', 'connections', 'filesender', './videocall.html!text'],
        function (
            ko, appevents, contactlist, peercomm, appsrvc, defs, utilities, bootbox, webrtccall, uuid, connections, filesender, template) {
                ...
                var viewModel = {
                    ...
                    dispose: function () {
                        try {
                            ...
                            mumble.notify.error("VideoCallVM dispose %j", err, true);
                        }
                    },
                    ...
                    onPeerHangup: function () {
                        ...
                        mumble.notify.info("The call has been terminated by the contact", null, true);
                    },
                    ...
                    sendfile: function () {
                        if (!peercomm.is_peer_session(viewModel.contact.name)) {
                            return mumble.notify.error_popup("Invalid contact session");
                        }
                    ...
                    showchat: function () {
                        ...
                        try {
                            ...
                            connections.create(viewModel.contact, true, taskid, function (err, webrtcconn) {
                                ...
                                if (!webrtcconn) {
                                    reported = true;
                                    return mumble.notify.error("Error in starting chat, no WebRTC connection", null, true);
                                }
                    ...
                    sendchat: function () {
                        try {
                            ...
                            mumble.notify.error("Send chat error %j", err, true);
                        }
                    },
