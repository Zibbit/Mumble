...
(function () {
    ...
    define(
        ['knockout', 'i18next', 'appevents', 'user', 'peercomm', 'appsrvc', 'definitions', 'uihandler', 'accounts', 'mumblenet', './createaccount.html!text'],
            ...
            this.submit = function () {
                ...
                try {
                    ...
                    .then(() => {
                        ...
                        mumble.notify.success("The account has been created and published to the Mumble network.");
                    ...
                    .catch(function (err) {
                        ...
                        processed = true;
                        uihandler.unblockwin();
                        mumble.notify.error("Error in creating the account: %j", err);
                    });

                    timer = setTimeout(function () {
                        uihandler.unblockwin();
                        if (!processed) {
                            mumble.notify.error("Error in connecting to Mumble, timed out");
                        }
                    }, 30000);
                    ...
                    mumble.notify.error("Error in creating the account user: %j", err);
                }
            };
        }
