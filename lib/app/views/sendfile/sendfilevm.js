        ...
        var viewModel = {
            ...
            onerror: function (hash, err, param) {
                try {
                    ...
                    mumble.notify.error("Send  file VM onerror: %j", err, true) 
                }
            },
            ...
            offer: function (params, callback) {
                ...
                peercomm.ping(viewModel.contact, true, 10000)
                    ...
                    .then(
                        function () {
                            return peercomm.initfile(viewModel.contact, filename, filesize, filehash, filetype, 20000)
                        },
                        function (err) {
                            throw new Error(err);
                        }
                    ...
                    .then(
                        function (isaccepted) {
                            ...
                            if (isaccepted == true) {
                                ...
                                mumble.notify.error("The contact refused to accept the file");
                            }
                        },
                        function (err) {
                            mumble.notify.error("Error in starting file transfer");
                        }
                    );
            },
            ...
            initsend: function (params) {
                try {
                    if (!params || !params.file || !params.md5hash || !params.file.size) {
                        return mumble.notify.error("Invalid send file parameters", null, true)
                    }
                    ...
                    viewModel.offer(params, function () {   
                        try {
                            ...
                            mumble.notify.error("Error in sending the file: " + e.message, null, true)
                        }
                    });
                }
                catch (e) {
            ...
            readfile: function () {
                try {
                    ...
                    bootbox.alert("Error in erading the file: " + e.message);
                }
            },
