        ...
        function OfflineRequestVm(params) {
            try {
                if (!appsrvc.cryptokey || !appsrvc.account_connected) {
                    ...
                    return mumble.notify.error("First initialize the account by connecting to the Mumble network");
                }
                ...
                mumble.notify.error("Error in creating offline contact request %j", err);
            }
        }           
