...
(function () {
    ...
    var uihandler = {
        ...
        loaddiv: ("#" + mumble.ui.load_container),
        maindiv: ("#" + mumble.ui.main),
        taskbar: ("#" + mumble.ui.taskbarmsg),
        ...
        init: function (knockout, jquery) {
            ...
            mumble.notify.error = function (err, param, istaskbar) {
                if (!err) { return; }
            ...
            mumble.notify.success = function (msg, param, istaskbar) {
            ...
            mumble.notify.info = function (msg, param, istaskbar) {
                var text = self.get_msg(msg, param);
                if (!istaskbar) {
            ...
            mumble.notify.hideprogress = function () { }

            mumble.ui.set_account_title = function (account) {
                document.title = (mumble.globals.appname || "Mumble") + " - " + account;
            };           

            mumble.ui.reset_title = function (account) {
                document.title = (mumble.globals.appname || "Mumble");
            };    
        },
        ...
        on_appload_error: function (error) {
            var msg = "Loading Mumble application failed. ";
