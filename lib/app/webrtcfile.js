...
(function () {
    ...
    function closeDataChannel() {
        try {
            ...
            mumble.notify.error("Close data channel error: %j", err, true) 
        }
    }
    ...
    webrtcfile.sendfile = function (params) {
        try {
            ...
            if (!params || !params.file || !params.md5hash) {
                throw new Error("invalid parameters");
            }
            var hash = params.md5hash;
                ...
                if (readyState === 'open') {
                    ...
                    try {
                        filetrans.initsend(
                            ...
                            params.md5hash, params.file.type, params.file.path,
            ...
            create_webrtc_connection(params.md5hash, onDataChannelStateChange, true);
    ...
    webrtcfile.receivefile = function (params) {
        try {
            ...
            var file = { size: params.file_size, name: params.file_name, type: params.file_type, hash: hash };
            var options = {
                contact: contact,
                file: file,
                is_sender: false
